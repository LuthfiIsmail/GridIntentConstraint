package com.example.intentparceable;
...
import com.example.intentparceable.R;
    ...
    public  void  onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Mohammad Luthfi Ismail Valent");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Mohammad Luthfi Ismail Valent");
                mPerson.setAge(17);
                mPerson.setEmail("luthfiismailv@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "087708702329";
